...
const STORIES = [
  {
    ...
    detail: "A Mumbai-based robotics startup used Trustora to finalize founder agreements and SAFE notes before their funding deadline.",
    tag: "Startup Law",
  },
  {
    metric: "₹18L saved",
  ...
  },
  {
    ...
    detail: "A retail business responded to a scrutiny notice with documentation prepared by a Trustora tax specialist — no penalty applied.",
    tag: "Taxation",
  },
];
