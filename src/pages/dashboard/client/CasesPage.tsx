...
import { CASES } from "@/data/testimonials.data";
import { DASHBOARD_DOCUMENTS } from "@/data/dashboardExtras.data";
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="space-y-4">
        {CASES.map((legalCase) => {
          const isOpen = expanded === legalCase.id;
          const docs = DASHBOARD_DOCUMENTS.filter((d) => d.caseId === legalCase.id);
