...
const SECTIONS: LegalSection[] = [
  {
    ...
    title: "Overview",
    paragraphs: [
      "Trustora (\"we\", \"our\", \"us\") operates a platform connecting clients with independent legal practitioners. This Privacy Policy explains what information we collect, how we use it, and the choices you have.",
      "By using Trustora, you agree to the collection and use of information in accordance with this policy.",
    ],
  },
  {
  ...
  },
  {
    ...
    paragraphs: [
      ...
      "You may request a full export of your data by contacting privacy@trustora.in.",
    ],
  },
  {
    id: "cookies",
  ...
  },
  {
    ...
    title: "Contact Us",
    paragraphs: [
      "Questions about this policy can be directed to privacy@trustora.in or through our Contact page.",
    ],
  },
];
