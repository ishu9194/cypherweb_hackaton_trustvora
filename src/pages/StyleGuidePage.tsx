...
export function StyleGuidePage() {
  ...
  return (
    <div className="mx-auto max-w-5xl px-4 py-12 sm:px-6 lg:px-8">
      ...
      <h1 className="mt-4 font-display text-3xl font-bold text-foreground">Trustora Design System</h1>
      ...
      <Section title="Data Display">
        ...
        <Accordion
          items={[
            { value: "a1", question: "What is Trustora?", answer: "A platform connecting clients with verified lawyers." },
