...
const SECTIONS: LegalSection[] = [
  {
    ...
    paragraphs: [
      "By accessing or using Trustora, you agree to be bound by these Terms & Conditions. If you do not agree, please do not use the platform.",
    ],
  },
  {
    id: "platform-role",
    ...
    paragraphs: [
      "Trustora is a marketplace connecting clients with independent, licensed legal practitioners. We do not provide legal advice ourselves and are not a law firm.",
      "Lawyers listed on Trustora operate as independent professionals responsible for their own advice, conduct, and compliance with Bar Council regulations.",
    ],
  },
  {
    id: "accounts",
  ...
  },
  {
    ...
    paragraphs: [
      "Trustora is not liable for the outcome of legal advice or representation provided by lawyers on the platform. Our liability is limited to facilitating the connection and payment process.",
    ],
  },
  {
    id: "changes",
  ...
  },
  {
    ...
    title: "Contact Us",
    paragraphs: [
      "Questions about these Terms can be directed to legal@trustora.in or through our Contact page.",
    ],
  },
];
