...
const MOCK_USERS: Record<string, User> = {
  client: { id: "u-1", name: "Meet Agrawal", email: "client@trustix.dev", role: "client", avatarUrl: "https://i.pravatar.cc/80?img=13" },
  lawyer: { id: "u-2", name: "Adv. Priya Sharma", email: "lawyer@trustix.dev", role: "lawyer", avatarUrl: "https://i.pravatar.cc/80?img=47" },
  admin: { id: "u-3", name: "Admin", email: "admin@trustix.dev", role: "admin", avatarUrl: "https://i.pravatar.cc/80?img=5" },
};
