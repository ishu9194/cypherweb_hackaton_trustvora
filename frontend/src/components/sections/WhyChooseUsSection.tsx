  ...
  return (
    <section className="mx-auto max-w-7xl px-4 py-24 sm:px-6 lg:px-8">
      <div className="grid grid-cols-1 items-center gap-14 lg:grid-cols-2">
        <div>
          <span className="text-xs font-semibold uppercase tracking-wider text-brand-600">Why Trustix</span>
          <h2 className="mt-3 font-display text-3xl font-bold text-foreground sm:text-4xl">
            Legal help you can actually trust
          </h2>
          <p className="mt-3 max-w-md text-muted-foreground">
            We built Trustix around the three things people say they hate most about hiring a
